...
class imagetopdf:
    ...
    def intialize_ui(self):
        title_label = tk.Label(self.root, text="Images to PDF Converter", font=("helvetika", 16, "bold"))
    ...
    def update_selected_images_listbox(self):
        self.selected_images_lisbox.delete(0, tk.END)
    ...
    def convert_images_to_pdf(self):
        ...
        for image_path in self.image_paths:
            ...
            pdf.rect(0, 0, 612, 729, fill=True)
        ...
        #     x = (612 - img_width) // 2  # Center horizontally
        #     y = (792 - img_height) // 2  # Center vertically


        #     pdf.setFillColorRGB(255, 255, 255)
        #     pdf.rect(0, 0, 612, 729, fill=True)
        #     pdf.drawInlineImage(image_path, x, y, width=img_width, height=img_height)
        #     pdf.showPage
